...
/**
 * This is a yaml mapping driver for Auditable
 * behavioral extension. Used for extraction of extended
 * metadata from yaml specifically for Auditable
 * extension.
 *
...
class Yaml extends File implements Driver
{
    ...
    /**
     * List of types which are valid for auditable
     *
     * @var array
     */
    ...
    public function readExtendedMetadata($meta, array &$config)
    {
        ...
        if (isset($mapping['fields'])) {
            foreach ($mapping['fields'] as $field => $fieldMapping) {
                if (isset($fieldMapping['gedmo']['auditable'])) {
                    $mappingProperty = $fieldMapping['gedmo']['auditable'];
